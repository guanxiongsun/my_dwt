...
def forward_model(model, feeder, outputSavePath, batchSize=1):
    with tf.Session() as sess:
        ...
        # tfBatchImages = tf.placeholder("float", shape=[1,1024,2048,3])
        # tfBatchSS = tf.placeholder("float", shape=[1,1024,2048])
        # tfBatchSSMask = tf.placeholder("float", shape=[1,1024,2048])
        # keepProb = tf.placeholder("float", shape=[1,1024,2048])
